...
namespace Automation.Web
{
    public class Tests
    {
        ...
        public void Test_Case_003_CreateNewBookingRecord()
        {
            ...
            var selectIsDeposit = new SelectElement(depositpaid);
            ...
            //deposit
            selectIsDeposit.SelectByText("false");
            ...
            //Sleep for the purpose of assessment so the assesors have time to view the tests in play
            Thread.Sleep(3000);
        ...
        {
            //TODO: Find the row ID created by the create function to determine which delete button corresponds. 
            NavigatetToTheHomepage();
            Assert.Pass();
        }
